...
#[component]
fn ParalaxImage(src: String) -> impl IntoView {
    view! {
        <div
...
fn AboutSection() -> impl IntoView {
    view! {
        <div class="row ps-sm-0" id="about_row" style="margin-top: 50px; transform: rotate(0deg)">
            ...
            <div
                class="col d-xl-flex align-self-center"
                data-aos="slide-left"
        ...
        ">
            ...
            <div class="row">
                <div class="col d-flex justify-content-center align-items-center flex-wrap">
                    ...
                    />
                    <div
                        class="text-center d-flex float-start justify-content-center align-items-center align-content-center flex-wrap"
            ...
            <small style="padding-left: 0px; font-size: 10px">
        ...
        <div class="col">
            <a href=link target="_blank" style="color: var(--bs-body-color)">
                <div
                    ...
                    style="min-height: 40vh; background: var(--bs-secondary-bg)"
                >
    ...
    view! {
        <section class="position-relative py-4 py-xl-5">
            <div class="container position-relative">
                <div class="row mb-5">
                    <div class="col-md-8 col-xl-6 text-center mx-auto">
                        <h2 style="margin-bottom: 0px">Get in Contact</h2>
                    </div>
                </div>
                        ...
                        <div class="d-flex flex-column justify-content-center align-items-start h-100">
                            ...
                            <div class="d-flex align-items-center p-3">
                                ...
                                <div class="px-2">
                                    ...
                                    // todo load this with JavaScript/wasm
...
fn BlogShowcase() -> impl IntoView {
    view! {
        <div
            ...
            "
        >
            <div class="row mb-5" style="padding-left: 0px">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2>Blog</h2>
                    <p class="w-lg-50">
...
pub fn Footer() -> impl IntoView {
    view! {
        <footer class="text-center" style="box-shadow: 0px 0px 5px">
            <div class="container text-muted py-4 py-lg-5">
                ...
                <p class="mb-0">Copyright {" © "} 2024 Jackson Coxson</p>
